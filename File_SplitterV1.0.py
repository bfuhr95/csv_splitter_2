...
class Program(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        tk.Tk.wm_geometry(self, "1500x500")
        self.frames = {}
...
class MainScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        welcome_message = tk.Label(self, text = "Welcome to File Splitter v1.0", font = LARGE_FONT)
